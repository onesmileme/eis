...
- (void)addHeader {
    _headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, FlexibleHeightTo6(240) + 67)];
    ...
    _echartsView = [[PYEchartsView alloc] initWithFrame:CGRectMake(15, 52, SCREEN_WIDTH - 30, FlexibleHeightTo6(240))];
