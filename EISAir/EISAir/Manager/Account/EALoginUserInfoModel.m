...
@implementation  EALoginUserInfoSitesProductsModel
...
@implementation  EALoginUserInfoSitesModel
...
@implementation  EALoginUserInfoOrgsModel
...
+(JSONKeyMapper *)keyMapper
{
    NSDictionary *dict = @{@"description":@"desc",@"id":@"orgId"};
    return [[JSONKeyMapper alloc]initWithModelToJSONDictionary:dict];
}
...
@implementation  EALoginUserInfoOrgsProductsModel
