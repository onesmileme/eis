...
{
    self.groupVc.cameraImage = cameraImage;
}

-(UIImage *)cameraImage
{
    return self.groupVc.cameraImage;
}

-(void)setPhotoLayout:(ZLPhotoLayout *)photoLayout
{
    self.groupVc.photoLayout = photoLayout;
}

-(ZLPhotoLayout *)photoLayout
{
    return self.groupVc.photoLayout;
}
